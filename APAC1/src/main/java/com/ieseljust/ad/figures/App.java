...
//public class com.ieseljust.ad.figures.App extends Application{
public class App extends Application{
    /* La nostra classe com.ieseljust.ad.figures.App principal és una
    ...
    // com.ieseljust.ad.figures.Escena és la classe que representarà la nostra escena
    ...
    public static void main(String[] args) {
        ...
        // com.ieseljust.ad.figures.FileManager serà el gestor d'emmagatzemamanet
        FileManager fm;
        ...
        do {
            ...
            System.out.print(Colors.Blue+"# com.ieseljust.ad.figures.Figura: "+Colors.Reset);
            String ordre = keyboard.nextLine();

            // Separem l'ordre introduida pel teclat en la forma: "com.ieseljust.ad.figures.Figura Posicio Mida Color"
            ...
            switch (figura){
                ...
                default:
                    ...
                    System.out.println(Colors.Bright_Red + "com.ieseljust.ad.figures.Figura no reconeguda" + Colors.Reset);
            }
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("com.ieseljust.ad.figures.Escena");
